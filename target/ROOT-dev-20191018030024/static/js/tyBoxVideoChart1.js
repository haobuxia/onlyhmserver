...
var playByTimeChartData = function (currTime) {
    ...
    $.each(chartMap, function (chartId, myChart) {
        ...
        //$$$$$$$$$ 需要你写代码的地方
        if (chartId == "video_chart_1") {
            var _min = parseInt(referenceValueList.ROTATION1.REQUIRED_HORSEPOWER.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.REQUIRED_HORSEPOWER.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_2") {
            var _min = parseInt(referenceValueList.ROTATION1.FINAL_REQUIRED_HORSEPOWER.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.FINAL_REQUIRED_HORSEPOWER.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_3") {
            var _min = parseInt(referenceValueList.ROTATION1.ENGINE_SPEED.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.ENGINE_SPEED.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_4") {
            var _min = parseInt(referenceValueList.ROTATION1.TSCI_ENG_MODE.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.TSCI_ENG_MODE.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_5") {
            var _min = parseInt(referenceValueList.ROTATION1.DISPLAY_LEVEL.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.DISPLAY_LEVEL.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_8") {
            var _min = parseInt(referenceValueList.ROTATION1.P_UCODE.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.P_UCODE.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_7") {
            var _min = parseInt(referenceValueList.ROTATION1.REQUIRED_DEVICE.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.REQUIRED_DEVICE.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_8") {
            var _min = parseInt(referenceValueList.ROTATION1.FAULT_DEGREE.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.FAULT_DEGREE.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_9") {
            var _min = parseInt(referenceValueList.ROTATION1.CONTROL_FLAG.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.CONTROL_FLAG.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_10") {
            var _min = parseInt(referenceValueList.ROTATION1.DIESEL_FLOW.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.DIESEL_FLOW.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_11") {
            var _min = parseInt(referenceValueList.ROTATION1.ENGINE_WATER.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.ENGINE_WATER.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_12") {
            var _min = parseInt(referenceValueList.ROTATION1.MAX_HP.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.MAX_HP.stateUp); //修改此处 为最大值
        } else if (chartId == "video_chart_0") {
            var _min = parseInt(referenceValueList.ROTATION1.HORSEPOWER_MODE.stateLower); //修改此处 为最小值
            var _max = parseInt(referenceValueList.ROTATION1.HORSEPOWER_MODE.stateUp); //修改此处 为最大值
        }
        myChart.setOption({
            series: [{
                markLine: {
    ...
    $.each(gaugeMap, function (chartId, myChart) {
        if (chartId == "video_chart_0") {
            ...
            var chartName = '最终要求马力率';
        } else if (chartId == "video_chart_3") {
            var chartName = '发动机转速';
        } else if (chartId == "video_chart_4") {
            var chartName = 'TSCI_ENG选择模式';
        } else if (chartId == "video_chart_5") {
            var chartName = '表示层面';
        } else if (chartId == "video_chart_6") {
            var chartName = 'P code,U code';
        } else if (chartId == "video_chart_7") {
            var chartName = '要求装置';
        } else if (chartId == "video_chart_8") {
            var chartName = '故障程度';
...
var loadChartData = function () {
    ...
    ajaxGet("/video/play/chartdata1/" + videoPage.videoId, function (resp) {
        if (resp.success) {
...
var setDataForVideo = function (doubleVo) {
    ...
    videoPage.gpsChartDataList.push("马力模式");
    videoPage.gpsChartDataList.push("要求马力率");
    videoPage.gpsChartDataList.push("最终要求马力率");
    videoPage.gpsChartDataList.push("发动机转速");
    videoPage.gpsChartDataList.push("TSCI_ENG选择模式");
    videoPage.gpsChartDataList.push("表示层面");
    videoPage.gpsChartDataList.push("P code,U code");
    videoPage.gpsChartDataList.push("要求装置");
    videoPage.gpsChartDataList.push("故障程度");

    videoPage.gpsChartDataList.push("控制标志");
    videoPage.gpsChartDataList.push("柴油流量");
    videoPage.gpsChartDataList.push("发动机水温");
    videoPage.gpsChartDataList.push("最大马力");
