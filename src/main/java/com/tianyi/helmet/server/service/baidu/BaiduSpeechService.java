...
//        System.setProperty("aip.log4j.conf", "path/to/your/log4j.properties");
    ...
    public String asrAudioToText(File audioFile, String format, HashMap<String, Object> options) {
        ...
        return asrAudioToText(byos.toByteArray(), format, options);
    }

    public String asrAudioToText(byte[] data, String format, HashMap<String, Object> options) {
        JSONObject asrRes = client.asr(data, format, 16000, options);
