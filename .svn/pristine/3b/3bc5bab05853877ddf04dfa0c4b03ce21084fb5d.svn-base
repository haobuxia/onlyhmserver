...
var loadData = function (page) {
    ...
    var url = "/helmetOnlineStats/statisticListByArea";
            ...
            if (resp.success) {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    _inner += "<tr>" +
                        ...
                        '<td>' + (_item.workNum==null?0:_item.workNum) + '</td>' +
                        '<td>' +
                        '<a onclick="statisticOne(\'' +  _item.userName + '\',\'' + _item.userId + '\',\'' + _item.department + '\',\'' + _item.loginSeconds + '\',\'' + _item.loginNum + '\')" class="label label-success">查看个人统计</a>';
                    _inner += '</td>' +
                            '</tr>';
