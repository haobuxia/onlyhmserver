...
<div class="panel clearfix">
    <div class="panel-heading">
        <h3 class="panel-title">按照标签统计视频量</h3>
    </div>

    <div class="panel-body col-md-10" id="searchSection">
        <div id="regDept">
            <div class="input-group" id="showBtn">
                ...
                <input type="text" id="department" placeholder="所属区域" class="form-control">
                <label for="department" class="input-group-addon">所属区域</label>
...
<script src="/static/js/helmetVideoTagStatsList.js?v=${version}"></script>
