    ...
    <div class="modal-dialog" role="document" style="width: 60%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">开机/拍摄时长统计</h4>
            </div>
            <div class="modal-body">
                <div>
                    <div align="center" style="margin-bottom:10px;">
                        <input type="text" id="videoLabel" class="form-control" readonly/>
                    </div>
                    <div id="videoChart" style="width: 900px;height:450px;"></div>
                </div>
            </div>
        </div>
    </div>
...
<script src="/static/js/helmetOnlineStatsList.js?v=${version}"></script>
