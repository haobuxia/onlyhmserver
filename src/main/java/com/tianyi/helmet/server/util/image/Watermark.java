...
public class Watermark {
    ...
    public BufferedImage apply(BufferedImage img) {
        ...
        BufferedImage imgWithWatermark = ImageUtils.createImage(img, width, height, null);
    ...
    private int[] resize(int width, int height) {
        ...
        this.watermarkImg = ImageUtils.createImage(this.watermarkImg, drawWidth, drawHeight, null);
