...
var loadMainContent = function (url,callbackFunc) {
    ...
    $.each(mainContentUnloadListeners, function (idx, listener) {
        try {
            ...
            console.error('mainContentUnloadListeners execute error.' + e);
        }
    });
...
var isAuthorized = function(permission) {
    ...
    var permis = $.grep(menuC, function(cur,i){
        return cur["id"]==permission;
    });
    if(permis.length > 0){
        return true;
    } else {
