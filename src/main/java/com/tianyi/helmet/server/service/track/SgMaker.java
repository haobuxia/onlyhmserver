 ...
 */
public abstract class SgMaker {
    public static final String CHANGE_LINE = "\n";

    private List<SgGpsDataTypeItemEnum> typeEnumList;
    ...
    public SgMaker(List<SgGpsDataTypeItemEnum> typeEnumList, LocalDateTime baseTime, LocalDateTime endTime) {
        this.typeEnumList = typeEnumList;
        this.typeEnumListSize = typeEnumList.size();
        this.timeValListMap = new HashMap<>(typeEnumList.size());
        for (SgGpsDataTypeItemEnum te : typeEnumList) {
     ...
     * @return
     */
    public abstract String valueFormat(SgGpsDataTypeItemEnum item, String val);
